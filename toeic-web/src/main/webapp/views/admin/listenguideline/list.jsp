                    ...
                    <div class="table-responsive">
                        <fmt:bundle basename="ApplicationResoures">
                            <display:table id="tableList" name="items.listResult" partialList="true" size="${items.totalItems}" pagesize="${items.maxPageItems}"
                                ...
                                <display:column property="title" titleKey="label.guidelinelisten.title" sortable="true"/>
                                <display:column property="content" titleKey="label.guidelinelisten.content" sortable="true"/>
                            </display:table>
                        </fmt:bundle>
